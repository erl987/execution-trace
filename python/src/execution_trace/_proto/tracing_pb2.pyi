...
class TraceEvent(_message.Message):
    __slots__ = ("timestamp_ns", "name", "source_type", "event_type", "sequence", "priority", "deadline_ms", "marker_value")
    ...
    deadline_ms: float
    marker_value: int
    def __init__(self, timestamp_ns: _Optional[int] = ..., name: _Optional[str] = ..., source_type: _Optional[_Union[TraceEventSourceType, str]] = ..., event_type: _Optional[_Union[TraceEventType, str]] = ..., sequence: _Optional[int] = ..., priority: _Optional[int] = ..., deadline_ms: _Optional[float] = ..., marker_value: _Optional[int] = ...) -> None: ...
